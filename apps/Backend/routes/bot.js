...
import { registrarOperacionesBot } from "../controllers/operacionesController.js";
...
// Registro de operaciones del mensaje (cola de aprobación)
router.post("/operaciones", registrarOperacionesBot);
